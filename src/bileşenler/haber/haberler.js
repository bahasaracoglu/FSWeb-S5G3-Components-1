...
function haberYapici(haberlerData) {
  ...
  let haberDiv = document.createElement("div");
  let haberBasligi = document.createElement("h2");
  let haberTarih = document.createElement("p");
  let haberP1 = document.createElement("p");
  let haberP2 = document.createElement("p");
  let haberP3 = document.createElement("p");
  ...
  haberBasligi.textContent = haberlerData.baslik;
  haberTarih.textContent = haberlerData.tarih;
  haberP1.textContent = haberlerData.ilkParagraf;
  haberP2.textContent = haberlerData.ikinciParagraf;
  haberP3.textContent = haberlerData.ucuncuParagraf;

  spanButton.textContent = "+";

  parent.appendChild(haberDiv);
  haberDiv.appendChild(haberBasligi);
  haberDiv.appendChild(haberTarih);
  haberDiv.appendChild(haberP1);
  haberDiv.appendChild(haberP2);
  haberDiv.appendChild(haberP3);
  haberDiv.appendChild(spanButton);

  let button = document.querySelector(".expandButton");
  let divArticle = document.querySelector(".article");

  button.addEventListener("click", (event) => {
    if (divArticle.className !== "article") {
      divArticle.classList.add("article-open");
    } else {
      divArticle.classList.remove("article-open");
    }
  });
